...
complaint_route.put(
  ...
  complaint_controller.updateExistingComplaint
);

complaint_route.get(
  "/all-complaint-portal/:complaineeId",
  complaint_controller.getAllCreateComplaintPortalService
);

complaint_route.get(
  "/all-complaints",
  complaint_controller.getAllExistingAndNonExistingComplaintsService
);
