...
const contactUserContentInfo = {
  CONTACT_USER_SUBJECT: `Thank You for Your Inquiry`,
  CONTACT_USER_CONTENT: `<p>Thank you for reaching out to the exclusive AFMX community! We appreciate your interest in AFMX. 
